function [cost_function,c,ceq] = compute_cost_const_old(u_opt, param, phases)
%{
...
[res] = extract_control_law_old (param, c_opt, phases);                          % initialize control matrix, time vector and x0 vector
