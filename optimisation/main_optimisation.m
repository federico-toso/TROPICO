function main_optimisation(param, phases)
%{
///////////////////////////////// to be updated/////////////////////
...
if isfield(param,'param.Scale_S1_Engine') || isfield(param,'Scale_S2_Engine') || isfield(param,'Scale_S1_Surf') ||...
...
[c0] = fg_gen (c0, LB, UB, param, phases);
...
options=optimset('Algorithm', 'sqp', ...                         % declare algorithm to use, here set to sequential quadratic programming (SQP)
    ...
    'TolCon', 1e-3, ...                                                     % tolerance on the constraint violation %'TolX', 1e-9, ...         % tolerance on the design vector     %
...
[c0, fval,exitflag,~,~,~,~] = objconstr (c0,LB, UB, options, param, phases);
